...
#     if tekshirsh[0] > 0:
#         await message.reply(
#             f"Taklif va mulohazalaringiz bo'lsa yoki savolingiz bo'lsa yozing. Ismingiz va nomeringizni qoldirishni unutmang  👨‍✈️Admin  bilan bog'lanmoqchi bo'lsangiz Ismingiz va raqamingizni yozib qoldiring Admin siz bilan 5 daqiqada bog'lanadi📞",
#             reply_markup=kb.main())
#         await state.finish()
#     else:
#         await message.reply(
#             "Assalomu alaykum xurmatli siz admin bilan bog'lanishingiz oson bo'lishi uchun iltimos.\nIsm familyangizni yozib qoldiring!")
#         await Add_user.full_name.set()
#     # await message.answer(f"<b>Quyosh chiqish vaqti: {tekshirsh}</b>",reply_markup=home)
#
